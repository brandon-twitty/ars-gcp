        ...
        <div class="main-bar header-middle bg-white">
            <div class="container">
                <div class="logo-header">
                    <a href="index.php">
                        <img src="images/ARS%20LOGO-header.png" width="216" height="37" alt="ARS Construction" />
                    </a>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 col-sm-6">
                        <div class="widget widget_services">
                            ...
                            <ul>
                                <li><a href="about-1.html">Residential</a></li>
                                <li><a href="faq-1.html">Commercial</a></li>
